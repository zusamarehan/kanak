...
<head>
    ...
    <title>Record Disbursement — Kanak Foundation</title>
    <meta name="description" content="Enter and record disbursements from recipients for Kanak Foundation.">
...
<body>
    ...
    <div class="container">
        ...
        <div class="top-bar-mobile" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 2rem; border-bottom: 1px solid var(--border-glow);">
            ...
            <nav style="display: flex; gap: 2rem;">
                ...
                <a href="/disbursement-entry" class="active" style="color: var(--text-main); text-decoration: none; font-size: 0.9rem; font-weight: 500; text-transform: uppercase; letter-spacing: 0.05em; position: relative; padding-bottom: 1rem; line-height: 1;">
                    Record Disbursement
        ...
        <!-- Form Card -->
        <div class="form-card" id="disbursement-form-card">
            <div class="form-card-header">
                <h1>Record Disbursement</h1>
                <p>Enter a new disbursement to a recipient below.</p>
            </div>

            <form id="disbursement-form" novalidate>
                <!-- Recipient Select -->
                ...
                <!-- Type -->
                <div class="form-group">
                    <label for="type">Type of Disbursement <span class="required">*</span></label>
                    <div class="select-wrapper">
                        <select id="type" class="form-select" required>
                            <option value="" disabled selected>Select a type…</option>
                            <option value="returnable">Returnable</option>
                            <option value="zakat">Zakat</option>
                            <option value="help">Grants / Help</option>
                        </select>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.getElementById('disbursement-form').addEventListener('submit', handleSubmit);
        ...
        async function handleSubmit(e) {
            ...
            try {
                ...
                if (res.ok && data.success) {
                    showToast('success', `Disbursement of ${formatter.format(data.data.amount)} recorded for ${data.data.recipient_name}.`);
